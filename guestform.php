...
<div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			...
			<p class="fontgrey shrift1">Изберете дата</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="unsetroomchosen.php" class="button round blackblur fontslabo" >2</a>
			<p class="fontgrey shrift1">Изберете стая</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#34bfde;">3</a>
			<p class="fontgrey shrift1">Вашите данни</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round blackblur fontslabo" >4</a>
			<p class="fontgrey shrift1">Резервацията е успешна</p>
		</div>
</div>
...
<div class="row">
		...
		<p class="shrift11"><b>Вашата резервация</b></p><hr class="line">
					...
					<div class="large-12 columns">
						<div class="row">
							...
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Настаняване
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Напускане
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Възрастни
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Деца
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Брой нощувки
								</span>
							</div>
						...
						<div class="row"><hr>
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Избрана стая
								</span>
							</div>
							
							<div class="large-4 columns" style="max-width:100%;">
								<span class="fontgreysmall shrift1">Брой
								</span>				
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							<p class="fontgrey borderstyle" style="text-align:center;">Необходим е 15% депозит<br>
							<span class="fontslabo " style="font-size:32px; text-align:center;"><?php echo $_SESSION['deposit'];?> Лева</span>
							<br><span class="fontgrey" style="text-align:center;">Общо</span><br>
							<span class="fontslabo" style="font-size:32px; text-align:center;"><?php echo $_SESSION['total_amount'];?> Лева</span></p>
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo shrift1" style="background-color:#34bfde; width:100%;">Промени резервация</button>
					</div>
				  </div>
				</form>
		</div>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		<p class="shrift11"><b>Вашите данни</b><hr class="line"></p>
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  <div class="row">

			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Име*
				<input name="firstname" type="text" value="<?php if(isset($_SESSION['firstname']) && !empty($_SESSION['firstname'])){echo  $_SESSION['firstname'];}?>" pattern="[a-zA-Z\u0400-\u04ff]{3,30}" Title="Позволени са само букви" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Фамилия*
				<input name="lastname" type="text" value="<?php if(isset($_SESSION['lastname']) && !empty($_SESSION['lastname'])){echo  $_SESSION['lastname'];}?>" pattern="[a-zA-Z\u0400-\u04ff]{3,30}" Title="Позволени са само букви" placeholder="" />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Имейл*
				<input name="email" type="email" value="<?php if(isset($_SESSION['email']) && !empty($_SESSION['email'])){echo  $_SESSION['email'];}?>" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="shrift1" style="color:grey !important;">Телефон*
				<input name="phone" type="text" id="phone" value="<?php if(isset($_SESSION['phone']) && !empty($_SESSION['phone'])){echo  $_SESSION['phone'];}?>" pattern= "[^a-zA-Z]+" Title="Позволени са само числа"  placeholder="" size="35"/>
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Адрес 1*
			...
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Адрес 2
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Пощенски код
				<input name="postcode" type="text"  value="<?php if(isset($_SESSION['postcode']) && !empty($_SESSION['postcode'])){echo  $_SESSION['postcode'];}?>" pattern= "[a-zA-Z0-9\s]+" Title="Специални символи като ( ) * & ^ % $ & и т.н. не са позволени><;"  placeholder=""/ />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Град*
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Област*
			...
			<div class="large-6 columns">
			  <label class="fontcolor shrift1">Държава*
				<select name="country" id="country" type="text" placeholder=""   required>
						...
						{
						echo "<option value=\"\" selected=\"true\">Държава</option>";
						}
		  ...
		  <div class="row">
			<div class="large-12 columns">
			  <label class="fontcolor shrift1">Специални изисквания
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo shrift1" style="background-color:#34bfde; margin-right: 150px; padding-right: 100px; padding-left: 100px;" onclick="return confirm('Сигурни ли сте, че искате да продължите?')" >Потвърди</button>
		  </div>
...
<script>
	function validateForm(form) {
		...
		var country = form.country.value;
			...
			{
			 alert("Моля попълнете всички полета маркирани със звезда *.");
