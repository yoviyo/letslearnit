      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li ><a href="dashboard.php"><i class="icon-gauge"></i> Резервации <span class="sr-only">(current)</span></a></li>
            
			<li class="active"><a href="room.php"><i class="icon-key"></i> Стаи</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="roomdetail">
          ...
          <h2 class="sub-header">Детайли за стаята</h2>
					...
					<?php 
						...
						if(mysqli_num_rows($result) > 0){
							while ($row = mysqli_fetch_array($result) ){
								...
								print "                  <td><a href=\"editroom.php?room_id=".$row['room_id']."\" \">Редактирай</a></td><td><a class=\"delete\" href=\"deleteroom.php?room_id=".$row['room_id']."\">Изтрий</a></td></tr>";					
		  ...
		  <button type="button" class="btn" id="addroom">Добави стая</button>
        </div>
		...
		<button type="button" class="btn" id="back">Назад</button>
					<form role="form" id="formnew" action="addroom.php" method="post" enctype="multipart/form-data">
					  <div class="form-group">
						<label for="room_name">Вид на стаята</label>
						<input type="text" class="form-control" name="room_name" id="room_name" placeholder="име на стаята" required>
					  </div>
					  <div class="form-group">
						<label for="total_room">Брой стаи</label>
						<input type="text" class="form-control" name="total_room"   id="total_room" placeholder="брой стаи" required>
					  </div>
					   <div class="form-group">
						<label for="occupancy">Места</label>
						<input type="text" class="form-control" name="occupancy" id="occupancy" placeholder="максимален капацитет на стаята">
					  </div>
					  <div class="form-group">
						<label for="size">Големина</label>
						<input type="text" class="form-control"  name="size" id="size" value="кв.м." placeholder="моля въведете големината на стаята">
					  </div>
					  <div class="form-group">
						<label for="view">Изглед</label>
						<input type="text" class="form-control" name="view" id="view" placeholder="например: Към морето" value="към морето">
					  </div>
					  <div class="form-group">
						<label for="rate">Цена</label>
						<input type="text" class="form-control"  nsme="rate" id="rate" placeholder=" " required>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						<label for="img">Качи снимка на стаята [препоръчаният размер е 400 X 400]</label>
