  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		print "						<label for=\"room_name\">Име на стая</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"room_name\" id=\"room_name\" placeholder=\"Име на стая\" value=\"".$rows['room_name']."\" required>\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"total_room\">Брой стаи</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"total_room\"   id=\"total_room\" placeholder=\"Брой стаи\" value=\"".$rows['total_room']."\" required>\n";
		print "					  </div>\n";
		print "					   <div class=\"form-group\">\n";
		print "						<label for=\"occupancy\">Места</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"occupancy\" id=\"occupancy\" placeholder=\"Максимум брой хора\" value=\"".$rows['occupancy']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"size\">Големина</label>\n";
		print "						<input type=\"text\" class=\"form-control\"  name=\"size\" id=\"size\" placeholder=\"Квадратни метри\" value=\"".$rows['size']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"view\">Изглед</label>\n";
		print "						<input type=\"text\" class=\"form-control\" name=\"view\" id=\"view\" placeholder=\"Каква е гледката на стаята\" value=\"".$rows['view']."\">\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"rate\">Цена</label>\n";
		print "						<input type=\"text\" class=\"form-control\"  name=\"rate\" id=\"rate\" placeholder=\" \" value=\"".$rows['rate']."\" required>\n";
		print "					  </div>\n";
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"desc\">Описание</label>\n";
		...
		print "					  <div class=\"form-group\">\n";
		print "						<label for=\"img\">Качи снимка на стаята</label>\n";
		print "						<input type=\"file\" id=\"img\" name=\"img\" >\n";
		print "						<!-- p class=\"help-block\">Example block-level help text here.</p-->\n";
		print "					  </div>\n";
		print "					  <button type=\"submit\" class=\"btn btn-default\">Обнови информацията за стаята</button>\n";
		print "					</form>";		
